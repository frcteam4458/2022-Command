...
RobotContainer::RobotContainer() : driveSubsystem{},
                                  ...
                                  //  fireCommand{&limitSubsystem, intakeCommand, shooterFastCommand, feedCommand, limitWaitCommand, flywheelWaitCommand},
                                   ...
                                   autoCommand{std::move(shooterSlowCommand), frc2::WaitCommand{3_s}, std::move(fireCommand), frc2::WaitCommand{1_s}, std::move(shooterStopCommand), std::move(autoDrive).WithTimeout(1.5_s)},
...
void RobotContainer::ConfigureButtonBindings()
{
  ...
  fireButton.WhenPressed(frc2::ParallelRaceGroup{std::move(intakeCommand), frc2::SequentialCommandGroup{frc2::WaitCommand{0.1_s}, std::move(feedCommand).WithTimeout(0.3_s), frc2::WaitCommand{1_s}, std::move(feedCommand).WithTimeout(0.3_s), frc2::WaitCommand{1_s}, std::move(shooterStopCommand)}});
